...
use {
    ...
    safecoin_sdk::{exit::Exit, pubkey::Pubkey, signature::Signer},
    solana_streamer::socket::SocketAddrSpace,
    safecoin_validator::port_range_validator,
    std::{
        collections::HashSet,
        env,
...
pub fn main() {
    ...
    let _logger_thread = safecoin_validator::redirect_stderr_to_file(logfile);
