...
use {
    ...
    wickandbergamot_entry::poh::compute_hashes_per_tick,
    wickandbergamot_genesis::{genesis_accounts::add_genesis_accounts, Base64Account},
...
fn main() -> Result<(), Box<dyn error::Error>> {
    let default_faucet_pubkey = wickandbergamot_cli_config::Config::default().keypair_path;
