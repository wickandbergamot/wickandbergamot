# |source| this file
#
# The WICKANDBERGAMOT_METRICS_CONFIG environment variable is formatted as a
# comma-delimited list of parameters. All parameters are optional.
#
# Example:
#   export WICKANDBERGAMOT_METRICS_CONFIG="host=<metrics host>,db=<database name>,u=<username>,p=<password>"
#
...
configureMetrics() {
  [[ -n $WICKANDBERGAMOT_METRICS_CONFIG ]] || return 0

  declare metricsParams
  IFS=',' read -r -a metricsParams <<< "$WICKANDBERGAMOT_METRICS_CONFIG"
