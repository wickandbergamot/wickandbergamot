...
impl DefaultSigner {
    ...
    /// use wickandbergamot_clap_utils::keypair::DefaultSigner;
    /// use wickandbergamot_clap_utils::offline::OfflineArgs;
    ///
    ...
    /// ```no_run
    /// use clap::{App, Arg, value_t_or_exit};
    /// use wickandbergamot_clap_utils::keypair::{DefaultSigner, signer_from_path};
    /// use wickandbergamot_clap_utils::offline::OfflineArgs;
    ...
    /// ```no_run
    /// use clap::{App, Arg, value_t_or_exit};
    /// use wickandbergamot_clap_utils::keypair::{SignerFromPathConfig, DefaultSigner};
    /// use wickandbergamot_clap_utils::offline::OfflineArgs;
    ///
    /// let clap_app = App::new("my-program")
    ///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use wickandbergamot_clap_utils::keypair::signer_from_path;
/// use wickandbergamot_clap_utils::offline::OfflineArgs;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use wickandbergamot_clap_utils::keypair::{signer_from_path_with_config, SignerFromPathConfig};
/// use wickandbergamot_clap_utils::offline::OfflineArgs;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use wickandbergamot_clap_utils::keypair::pubkey_from_path;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::with_name("keypair")
...
/// ```no_run
/// use clap::{App, Arg, value_t_or_exit};
/// use wickandbergamot_clap_utils::keypair::keypair_from_path;
///
/// let clap_app = App::new("my-program")
///     // The argument we'll parse as a signer "path"
///     .arg(Arg::with_name("keypair")
