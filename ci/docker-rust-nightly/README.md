...
of the [Wickandbergamot](https://hub.docker.com/u/solanalabs/) Docker Hub
organization.
...
1. Run `WICKANDBERGAMOT_ALLOCATE_TTY=1 WICKANDBERGAMOT_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull solanalabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `WICKANDBERGAMOT_ALLOCATE_TTY=1 WICKANDBERGAMOT_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull solanalabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
