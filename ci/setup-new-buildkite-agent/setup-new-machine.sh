...
cat >/etc/apt/apt.conf.d/99-WICKANDBERGAMOT <<'EOF'
...
"$WICKANDBERGAMOT_ROOT"/net/scripts/install-docker.sh
usermod -aG docker "$SETUP_USER"
"$WICKANDBERGAMOT_ROOT"/net/scripts/install-certbot.sh
...
"$WICKANDBERGAMOT_ROOT"/net/scripts/install-earlyoom.sh
"$WICKANDBERGAMOT_ROOT"/net/scripts/install-nodejs.sh
"$WICKANDBERGAMOT_ROOT"/net/scripts/localtime.sh
"$WICKANDBERGAMOT_ROOT"/net/scripts/install-redis.sh
"$WICKANDBERGAMOT_ROOT"/net/scripts/install-rsync.sh
"$WICKANDBERGAMOT_ROOT"/net/scripts/install-libssl-compatability.sh
