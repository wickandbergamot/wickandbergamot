...
"$SAFECOIN_ROOT"/net/scripts/install-docker.sh
usermod -aG docker "$SETUP_USER"
"$SAFECOIN_ROOT"/net/scripts/install-certbot.sh
...
"$SAFECOIN_ROOT"/net/scripts/install-earlyoom.sh
"$SAFECOIN_ROOT"/net/scripts/install-nodejs.sh
"$SAFECOIN_ROOT"/net/scripts/localtime.sh
"$SAFECOIN_ROOT"/net/scripts/install-redis.sh
"$SAFECOIN_ROOT"/net/scripts/install-rsync.sh
"$SAFECOIN_ROOT"/net/scripts/install-libssl-compatability.sh
