...
function parse_stake_account_data_to_file {
  ...
  account_data="$(wickandbergamot --url "$url" show-stake-account "$account_key")"
...
function display_results_summary {
  ...
  stake_account_balance_total_sol="$(bc <<< "scale=3; $stake_account_balance_total/$LAMPORTS_PER_WICKANDBERGAMOT")"
  system_account_balance_sol="$(bc <<< "scale=3; $system_account_balance/$LAMPORTS_PER_WICKANDBERGAMOT")"

  all_account_total_balance="$(bc <<< "scale=3; $system_account_balance+$stake_account_balance_total")"
  all_account_total_balance_sol="$(bc <<< "scale=3; ($system_account_balance+$stake_account_balance_total)/$LAMPORTS_PER_WICKANDBERGAMOT")"
