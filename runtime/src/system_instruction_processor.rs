...
pub fn process_instruction(
    ...
    match instruction {
        ...
        SystemInstruction::AdvanceNonceAccount => {
            ...
            #[allow(deprecated)]
            if from_keyed_account::<safecoin_sdk::sysvar::recent_blockhashes::RecentBlockhashes>(
        ...
        SystemInstruction::WithdrawNonceAccount(lamports) => {
            ...
            #[allow(deprecated)]
            let _ = from_keyed_account::<safecoin_sdk::sysvar::recent_blockhashes::RecentBlockhashes>(
...
mod tests {
    ...
    use {
        ...
        bincode::serialize,
        safecoin_program_runtime::invoke_context::{mock_process_instruction, InvokeContext},
