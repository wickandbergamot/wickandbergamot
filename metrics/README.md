...
release channels:
* https://metrics.wickandbergamot.org:3000/d/monitor-edge/cluster-telemetry-edge
* https://metrics.wickandbergamot.org:3000/d/monitor-beta/cluster-telemetry-beta
* https://metrics.wickandbergamot.org:3000/d/monitor/cluster-telemetry
...
* Check out metrics to add at https://metrics.wickandbergamot.org:8888/ in the data explorer.
...
```
$ export GRAFANA_API_TOKEN="an API key from https://metrics.wickandbergamot.org:3000/org/apikeys"
