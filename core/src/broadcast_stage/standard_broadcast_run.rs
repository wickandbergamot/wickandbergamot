...
impl StandardBroadcastRun {
    ...
    fn entries_to_shreds(
        ...
        let (next_shred_index, next_code_index) = match &self.unfinished_slot {
            ...
            None => {
                ...
                // recreate the slot:
                // https://github.com/wickandbergamot/wickandbergamot/blob/ff68bf6c2/ledger/src/leader_schedule_cache.rs#L142-L146
    ...
    fn process_receive_results(
        ...
        // https://github.com/wickandbergamot/wickandbergamot/blob/53695ecd2/core/src/broadcast_stage/standard_broadcast_run.rs#L334-L339
    ...
    fn insert(
        ...
        // https://github.com/wickandbergamot/wickandbergamot/blob/53695ecd2/core/src/broadcast_stage/standard_broadcast_run.rs#L239-L246
