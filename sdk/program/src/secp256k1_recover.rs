...
//!
//! While `secp256k1_recover` can be used to verify secp256k1 signatures, Wickandbergamot
...
/// comparing the recovered key against an expected key, Wickandbergamot also provides
...
///
/// **The Wickandbergamot `secp256k1_recover` function does not prevent signature
/// malleability**. This is in contrast to the Bitcoin secp256k1 library, which
/// does prevent malleability by default. Wickandbergamot accepts signatures with `S`
...
/// version 0.7.0 or greater is required for running on the Wickandbergamot BPF target.
///
/// [`libsecp256k1`]: https://docs.rs/libsecp256k1/latest/libsecp256k1
///
...
/// signature with the `secp256k1_recover` syscall. It has three parts: a Wickandbergamot
...
/// ```
///
/// The Wickandbergamot program. Note that it uses `libsecp256k1` version 0.7.0 to parse
...
///     // Wickandbergamot does not do this itself.
