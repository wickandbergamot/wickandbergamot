//! Types for directing the execution of Wickandbergamot programs.
//!
//! Every invocation of a Wickandbergamot program executes a single instruction, as
...
//! the Wickandbergamot runtime. This allows flexibility in how programs behave, how they
...
pub enum InstructionError {
    ...
    /// by the Wickandbergamot runtime. A program-specific error may be any type that is represented as
    ...
    /// consistent across Wickandbergamot software versions.
    ///
...
/// A directive for a single invocation of a Wickandbergamot program.
///
/// An instruction specifies which program it is calling, which accounts it may
/// read or modify, and additional data that serves as input to the program. One
/// or more instructions are included in transactions submitted by Wickandbergamot
...
/// construction.
///
/// While Wickandbergamot is agnostic to the format of the instruction data, it has
...
///
/// When building a transaction, the Wickandbergamot runtime coalesces all accounts used
...
///
/// Note that because the Wickandbergamot runtime schedules parallel transaction
...
/// which is the core of a Wickandbergamot transaction. It is created during the
