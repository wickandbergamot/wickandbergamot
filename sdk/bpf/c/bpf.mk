...
ifeq ($(WICKANDBERGAMOT_SBFV2),1)
C_FLAGS := \
  $(C_FLAGS) \
  -DWICKANDBERGAMOT_SBFV2=1
endif
...
ifeq (,$(wildcard $(subst .so,-keypair.json,$1)))
	$(_@)wickandbergamot-keygen new --no-passphrase --silent -o $(subst .so,-keypair.json,$1)
endif
	@echo To deploy this program:
	@echo $$$$ wickandbergamot program deploy $(abspath $1)
endef
