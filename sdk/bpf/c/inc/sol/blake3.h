#pragma once
/**
 * @brief Wickandbergamot Blake3 system call
 */
...
uint64_t sol_blake3(const WickandbergamotBytes *, int, const uint8_t *);
#else
typedef uint64_t(*sol_blake3_pointer_type)(const WickandbergamotBytes *, int, const uint8_t *);
static uint64_t sol_blake3(const WickandbergamotBytes * arg1, int arg2, const uint8_t * arg3) {
