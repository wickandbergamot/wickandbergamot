#pragma once
/**
 * @brief Wickandbergamot logging utilities
 */
...
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/bpf/c/inc/sol/inc/log.inc AND RUN `cargo run --bin gen-headers` */
#ifndef WICKANDBERGAMOT_SBFV2
void sol_log_data(WickandbergamotBytes *, uint64_t);
#else
typedef void(*sol_log_data_pointer_type)(WickandbergamotBytes *, uint64_t);
static void sol_log_data(WickandbergamotBytes * arg1, uint64_t arg2) {
 ...
 */
static void sol_log_params(const WickandbergamotParameters *params) {
