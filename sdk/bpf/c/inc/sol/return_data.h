#pragma once
/**
 * @brief Wickandbergamot return data system calls
**/
...
/* DO NOT MODIFY THIS GENERATED FILE. INSTEAD CHANGE sdk/bpf/c/inc/sol/inc/return_data.inc AND RUN `cargo run --bin gen-headers` */
#ifndef WICKANDBERGAMOT_SBFV2
uint64_t sol_get_return_data(uint8_t *, uint64_t, WickandbergamotPubkey *);
#else
typedef uint64_t(*sol_get_return_data_pointer_type)(uint8_t *, uint64_t, WickandbergamotPubkey *);
static uint64_t sol_get_return_data(uint8_t * arg1, uint64_t arg2, WickandbergamotPubkey * arg3) {
