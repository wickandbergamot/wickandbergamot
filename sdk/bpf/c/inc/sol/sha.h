#pragma once
/**
 * @brief Wickandbergamot sha system call
 */
...
uint64_t sol_sha256(const WickandbergamotBytes *, int, uint8_t *);
#else
typedef uint64_t(*sol_sha256_pointer_type)(const WickandbergamotBytes *, int, uint8_t *);
static uint64_t sol_sha256(const WickandbergamotBytes * arg1, int arg2, uint8_t * arg3) {
