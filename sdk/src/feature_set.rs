...
pub mod cap_bpf_program_instruction_accounts {
    solana_sdk::declare_id!("ZMe3G91j5MYBRdxMELJPa5WKyGF35geL1CAf2ge55Y8");
}

pub mod loosen_cpi_size_restriction {
    solana_sdk::declare_id!("6bHAHY3xkTEGzzqu4dweMYqhiAXVAC2dUj2QDgXoe7uP");
}

pub mod use_default_units_in_fee_calculation {
    solana_sdk::declare_id!("5tYtSxXTy9SWv7RoHPa5FSFTVuuqdvS5qv22nkpAaYDS");
}

pub mod compact_vote_state_updates {
    solana_sdk::declare_id!("3Av7XvYZmZ6RBhQeM4Wt54aKN3iJtW2HsErG7wxwPwqE");
}

pub mod concurrent_replay_of_forks {
    solana_sdk::declare_id!("8v9fX8s1QR8fbH6T5AyPHBp67SMZNSvcBkMbJzeoktK4");
}

pub mod incremental_snapshot_only_incremental_hash_calculation {
    solana_sdk::declare_id!("EM2qfX7PqW1JhGFThHUeVQ8GFaHBGFmae7G7oP1Jbwbk");
}

pub mod vote_state_update_root_fix {
    solana_sdk::declare_id!("F9hCEfctdkoka5Mcjkq2YvusjZymxRfADYf4Vo7tbRmC");
}

pub mod return_none_for_zero_lamport_accounts {
    solana_sdk::declare_id!("4uFe1EAUqBRUfXHhHuGc9oAG42yymQMY1WQKuV4iLEpa");
}

pub mod disable_rehash_for_rent_epoch {
    solana_sdk::declare_id!("J1fn5rAjqRuSi3fx9iHZbvux1cSdTNDDAzatTvbtXEcF");
}

pub mod on_load_preserve_rent_epoch_for_rent_exempt_accounts {
    solana_sdk::declare_id!("CwAfu54G3uayqUt3YUhbGBZhBxf6nY3NRGZtinXCsBV");
}

pub mod increase_tx_account_lock_limit {
    solana_sdk::declare_id!("59ub3TYn7sigxPDqbLcNLE579DJZrW3DgPerQ9dkpQMX");
}

pub mod check_syscall_outputs_do_not_overlap {
    solana_sdk::declare_id!("6GLqd1nKHsQzabMdUaz3ppfyrVq3Dc3dcWFNZUEc9gKe");
}

pub mod commission_updates_only_allowed_in_first_half_of_epoch {
    solana_sdk::declare_id!("HbQhEfjaT3JW6HAftt9DnZPeJSgPVFJcVqAo4YyLXS6P");
}

pub mod enable_turbine_fanout_experiments {
    solana_sdk::declare_id!("GHPrWcXHqfHvHX4RCZ4oTEnEEQHcf4QJxqsFvm3MaWC4");
}

pub mod disable_turbine_fanout_experiments {
    solana_sdk::declare_id!("93NxcLB9SR2dMLRBNqkw7S3koiSQm6LmFYgJAnbXPC3a");
}

pub mod drop_merkle_shreds {
    solana_sdk::declare_id!("ExaQpo9PVJigohcXpEFzeVaYi3bPATpHx9J9wbEqRCex");
}

pub mod keep_merkle_shreds {
    solana_sdk::declare_id!("7pD9setQSbrYSKJTh23qTRFnZLpMuGp9zNwQ6C3oRHKe");
}

pub mod move_serialized_len_ptr_in_cpi {
    solana_sdk::declare_id!("B5FXDmNzjpZqcp5jvJtWfgBA14c5KYRLT959gdh8uR1Z");
}

pub mod enable_request_heap_frame_ix {
    solana_sdk::declare_id!("5i8xgKX9kiD3tgkSwpvJWKa3dmtrLBNbuEXDS93JQy22");
}
