...
pub enum LedgerError {
    #[error("Wickandbergamot app not open on Ledger device")]
    ...
    #[error("Ledger received invalid Wickandbergamot message")]
    WickandbergamotInvalidMessage = 0x6a80,

    #[error("Wickandbergamot summary finalization failed on Ledger device")]
    WickandbergamotSummaryFinalizeFailed = 0x6f00,

    #[error("Wickandbergamot summary update failed on Ledger device")]
    WickandbergamotSummaryUpdateFailed = 0x6f01,
