...
following month.
* The SAFE/USD conversion rate used for payments is the market price at the end of
...
* For example, for all bugs submitted in March 2021, the SAFE/USD price for bug
