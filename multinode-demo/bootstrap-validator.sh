...
identity=$WICKANDBERGAMOT_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$WICKANDBERGAMOT_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$WICKANDBERGAMOT_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
