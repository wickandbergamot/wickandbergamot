...
declare_syscall!(
    ...
    fn call(
        ...
        use wickandbergamot_zk_token_sdk::curve25519::{curve_syscall_traits::*, edwards, ristretto};
...
declare_syscall!(
    ...
    fn call(
        ...
        use wickandbergamot_zk_token_sdk::curve25519::{
...
mod tests {
    ...
    fn test_syscall_edwards_curve_point_validation() {
        use wickandbergamot_zk_token_sdk::curve25519::curve_syscall_traits::CURVE25519_EDWARDS;
    ...
    fn test_syscall_ristretto_curve_point_validation() {
        use wickandbergamot_zk_token_sdk::curve25519::curve_syscall_traits::CURVE25519_RISTRETTO;
    ...
    fn test_syscall_edwards_curve_group_ops() {
        use wickandbergamot_zk_token_sdk::curve25519::curve_syscall_traits::{
