...
Developers can write and deploy their own programs to the wickandbergamot blockchain.
...
Wickandbergamot on-chain programs are compiled via the [LLVM compiler
...
Because Wickandbergamot uses the LLVM compiler infrastructure, a program may be written
in any programming language that can target the LLVM's BPF backend. Wickandbergamot
...
The virtual address memory map used by Wickandbergamot BPF programs is fixed and laid out
as follows
...
The Wickandbergamot Program Library math tests will report the performance of some math
operations:
https://github.com/wickandbergamot/wickandbergamot-program-library/tree/master/libraries/math
...
[`Write`](https://github.com/wickandbergamot/wickandbergamot/blob/bc7133d7526a041d1aaee807b80922baa89b6f90/sdk/program/src/loader_instruction.rs#L13)
...
[`Finalize`](https://github.com/wickandbergamot/wickandbergamot/blob/bc7133d7526a041d1aaee807b80922baa89b6f90/sdk/program/src/loader_instruction.rs#L30)
