...
Wickandbergamot exposes a variety of cluster state data to programs via
...
crate](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/sysvar/index.html),
and outlined below.
...
- Layout: [Clock](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/clock/struct.Clock.html)
- Fields:
...
- Layout:
  [EpochSchedule](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/epoch_schedule/struct.EpochSchedule.html)
...
- Layout:
  [Fees](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/sysvar/fees/struct.Fees.html)
...
- Layout:
  [Instructions](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/sysvar/instructions/struct.Instructions.html)
...
- Layout:
  [RecentBlockhashes](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/sysvar/recent_blockhashes/struct.RecentBlockhashes.html)
...
- Layout:
  [Rent](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/rent/struct.Rent.html)
...
- Layout:
  [SlotHashes](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/slot_hashes/struct.SlotHashes.html)
...
- Layout:
  [SlotHistory](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/slot_history/struct.SlotHistory.html)
...
- Layout:
  [StakeHistory](https://docs.rs/-program/VERSION_FOR_DOCS_RS/solana_program/stake_history/struct.StakeHistory.html)
