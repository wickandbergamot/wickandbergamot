...
Wickandbergamot contains a small handful of native programs, which are required to run
...
- Instructions: [SystemInstruction](https://docs.rs/wickandbergamot-program/VERSION_FOR_DOCS_RS/solana_program/system_instruction/enum.SystemInstruction.html)
...
- Instructions: [config_instruction](https://docs.rs/wickandbergamot-config-program/VERSION_FOR_DOCS_RS/solana_config_program/config_instruction/index.html)
...
- Instructions: [StakeInstruction](https://docs.rs/wickandbergamot-sdk/VERSION_FOR_DOCS_RS/solana_sdk/stake/instruction/enum.StakeInstruction.html)
...
- Instructions: [VoteInstruction](https://docs.rs/wickandbergamot-vote-program/VERSION_FOR_DOCS_RS/solana_vote_program/vote_instruction/enum.VoteInstruction.html)
...
- Instructions: [LoaderInstruction](https://docs.rs/wickandbergamot-sdk/VERSION_FOR_DOCS_RS/solana_sdk/loader_upgradeable_instruction/enum.UpgradeableLoaderInstruction.html)
...
instruction via a program id, the Wickandbergamot runtime will load both your the program
...
- Instructions: [new_ed25519_instruction](https://github.com/wickandbergamot/wickandbergamot/blob/master/sdk/src/ed25519_instruction.rs#L45)
...
- Instructions: [new_secp256k1_instruction](https://github.com/wickandbergamot/wickandbergamot/blob/1a658c7f31e1e0d2d39d9efbc0e929350e2c2bcb/sdk/src/secp256k1_instruction.rs#L31)
