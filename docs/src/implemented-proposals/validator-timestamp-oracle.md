...
Third-party users of Wickandbergamot sometimes need to know the real-world time a block
...
would allow a Wickandbergamot cluster to satisfy this need.
...
As of https://github.com/wickandbergamot/wickandbergamot/pull/10630, validators submit a
