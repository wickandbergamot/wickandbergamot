...
Safecoin通过[`sysvar`](terminology.md#sysvar)帐户向程序公开了各种群集状态数据。 这些帐户填充在[`safecoin-program`开发工具](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/sysvar/index.html)中发布的已知地址以及帐户布局中，并在下面概述。
...
- 布局：[时钟](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/clock/struct.Clock.html)
- 栏位：
  - `slot`：当前的插槽
...
- 布局：[EpochSchedule](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/epoch_schedule/struct.EpochSchedule.html)
...
- 布局：[费用](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/sysvar/fees/struct.Fees.html)
...
- 布局：[指令](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/sysvar/instructions/type.Instructions.html)
...
- 布局：[RecentBlockhashes](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/sysvar/recent_blockhashes/struct.RecentBlockhashes.html)
...
- 赞成：[出租](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/rent/struct.Rent.html)
...
- 布局：[SlotHashes](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/slot_hashes/struct.SlotHashes.html)
...
- 布局：[SlotHistory](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/slot_history/struct.SlotHistory.html)
...
- 布局：[StakeHistory](https://docs.rs/safecoin-program/VERSION_FOR_DOCS_RS/safecoin_program/stake_history/struct.StakeHistory.html)
